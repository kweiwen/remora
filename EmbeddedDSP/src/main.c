...
#include "ADDS_21479_EzKit.h" 		/* Get definition of global variable */

/* Hardware Initialization, including SDRAM/DAI/DPI/Codec */
#include "init_PLL_SDRAM.h" 		/* Get definition of initPLL(), initExternalMemory() */
#include "initSRU.h"				/* Get definition of initDAI() */
#include "init4272viaSPI.h"			/* Get definition of InitCS4272() */
#include "initSPORT01_I2S_mode.h"	/* Get definition of initSPORT() */

/* Interrupt Implementation */
#include "SPORT1_isr.h"				/* Get definition of TalkThroughISR() */
#include "SPIB_isr.h"     			/* Get definition of SPIBTransferISR() */
#include "UART0_isr.h"				/* Get definition of UART0ISR(), initUART();*/

/* Function and Application */
#include "blockProcess_audio.h"     /* Get definition of handleCodecData() */
#include "flash_edit.h"		/* Get definition of firmware_upgrade() */
#include "serial_flash.h"       	/* Get definition of initSPI() */
#include "led_blink.h"				/* Get definition of Blink_LED(), Set_LED(), Clear_LED() */
